...
echo 'alias ntatgss-chain="$HOME/core-bridgechain/packages/core/bin/run"' >> ~/.bashrc

rm -rf "$HOME/core-bridgechain"
git clone "https://github.com/ntatgss/core" "$HOME/core-bridgechain" || FAILED="Y"
if [ "$FAILED" == "Y" ]; then
    echo "Failed to fetch core repo with origin 'https://github.com/ntatgss/core'"
...
rm -rf "$HOME/.config/@ntatgss-chain"
rm -rf "$HOME/.config/@ntatgss-chain"
rm -rf "$HOME/.config/ntatgss-chain-core"
